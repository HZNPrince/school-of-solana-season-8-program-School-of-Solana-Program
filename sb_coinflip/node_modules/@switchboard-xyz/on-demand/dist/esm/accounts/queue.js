...
import { getAssociatedTokenAddress, getNodePayer, isMainnetConnection, } from '../utils/index.js';
...
export class Queue {
    ...
    fetchGatewayByLatestVersion(crossbar) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const gatewayUrls = yield crossbar.fetchGateways(this.network === CrossbarNetwork.SolanaMainnet ? 'mainnet' : 'devnet');
            const gatewayHealths = [];
            // Check health of all gateways
            for (const gatewayUrl of gatewayUrls) {
                try {
                    const healthUrl = `${gatewayUrl}/gateway/api/v1/test`;
                    const response = yield axios.get(healthUrl);
     ...
     * ```
     */
    fetchOracleByLatestVersion() {
        return __awaiter(this, void 0, void 0, function* () {
            // Fetch all oracle keys from the queue (internally calls loadData)
            const oracleKeys = yield this.fetchOracleKeys();
    ...
    fetchSignaturesConsensus(params) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const gateway = yield crossbarClient.fetchGateway();
    ...
    setConfigsIx(params) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const ix = yield this.program.instruction.queueSetConfigs({
                ...
                oracleFeeProportionBps: (_c = params.oracleFeeProportionBps) !== null && _c !== void 0 ? _c : null,
            }, {
                accounts: {
                    queue: this.pubkey,
    ...
    fetchQuoteIx(crossbar, feedHashesOrFeeds, configs) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let gateway;
            try {
                gateway = yield crossbar.fetchGateway();
            }
            catch (error) {
            ...
            if (typeof feedHashesOrFeeds[0] === 'string') {
                ...
                response = yield gateway.fetchQuote(crossbar, feedHashes, (_a = config.numSignatures) !== null && _a !== void 0 ? _a : 1, config.variableOverrides);
            }
            else {
                ...
                response = yield gateway.fetchSignaturesConsensus({
            ...
            const ed25519Signatures = response.oracle_responses.map((oracleResponse, index) => {
                ...
                for (const feedResponse of oracleResponse.feed_responses) {
                    ...
                    feedInfoBuffers.push(Buffer.concat([
            ...
            if (typeof response.slot !== 'number') {
                ...
                slot = response.slot.toNumber();
            }
            const ed25519Instruction = Ed25519InstructionUtils.buildEd25519Instruction(ed25519Signatures, (_b = config.instructionIdx) !== null && _b !== void 0 ? _b : 0, slot, 0 // version 0 for Ed25519 v0 scheme
            );
    ...
    fetchManagedUpdateIxs(crossbar, feedHashesOrFeeds, configs) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const [oracleAccount, bump] = OracleQuote.getCanonicalPubkey(this.pubkey, feedHashes, QUOTE_PROGRAM_ID);
            ...
            const payer = (_a = config.payer) !== null && _a !== void 0 ? _a : getNodePayer(this.program).publicKey;
            const opcode = 0;
            ...
            const quoteProgramIx = new web3.TransactionInstruction({
                ...
                data: Buffer.from([opcode, (_b = config.instructionIdx) !== null && _b !== void 0 ? _b : 0, bump]), // ix_idx - index of Ed25519 instruction in transaction
            });
