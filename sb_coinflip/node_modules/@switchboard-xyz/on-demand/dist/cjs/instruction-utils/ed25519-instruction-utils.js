...
exports.Ed25519InstructionUtils = void 0;
...
class Ed25519InstructionUtils {
    ...
    static buildEd25519Instruction(signatures, instructionIndex, recentSlot, version) {
        ...
        return new anchor_31_1.web3.TransactionInstruction({
            programId: anchor_31_1.web3.Ed25519Program.programId,
            data: Buffer.from(instrData),
            keys: [],
        });
    }
}
exports.Ed25519InstructionUtils = Ed25519InstructionUtils;
...
//# sourceMappingURL=ed25519-instruction-utils.js.map