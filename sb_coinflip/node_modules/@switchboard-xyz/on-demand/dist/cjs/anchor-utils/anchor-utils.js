...
class AnchorUtils {
    ...
    static loadEnv() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const crossbar = new common_1.CrossbarClient('http://crossbar.switchboard.xyz');
            ...
            const queueKey = isMainnet
                ? queue_js_1.Queue.DEFAULT_MAINNET_KEY
                : queue_js_1.Queue.DEFAULT_DEVNET_KEY;
            const queue = new queue_js_1.Queue(program, queueKey);
            // Set the network on the queue instance for future use
            queue.setNetwork(network);
            const gateway = yield crossbar.fetchGateway();
            return {
