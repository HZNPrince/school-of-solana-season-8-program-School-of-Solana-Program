...
class Queue {
    ...
    fetchGatewayByLatestVersion(crossbar) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const gatewayUrls = yield crossbar.fetchGateways(this.network === common_1.CrossbarNetwork.SolanaMainnet ? 'mainnet' : 'devnet');
            ...
            const gateway = new gateway_js_1.Gateway(selectedGateway.url);
            return gateway;
        });
    }
    /**
    ...
    fetchOracleByLatestVersion() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return new oracle_js_1.Oracle(this.program, selectedOracleKey);
        });
    }
    /**
    ...
    fetchQuoteIx(crossbar, feedHashesOrFeeds, configs) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const ed25519Instruction = ed25519_instruction_utils_js_1.Ed25519InstructionUtils.buildEd25519Instruction(ed25519Signatures, (_b = config.instructionIdx) !== null && _b !== void 0 ? _b : 0, slot, 0 // version 0 for Ed25519 v0 scheme
            );
