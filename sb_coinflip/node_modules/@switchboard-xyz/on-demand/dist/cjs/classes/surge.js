...
class SurgeUpdate {
    ...
    toBundleIx(instructionIdx = 0) {
        ...
        if (response.oracle_response.ed25519_enclave_signer) {
            ...
            const secpInstruction = secp256k1_instruction_utils_js_1.Secp256k1InstructionUtils.buildSecp256k1Instruction(secpSignatures, instructionIdx);
            ...
            const data = {
                ...
                feedInfos: ((_a = response.feed_values) === null || _a === void 0 ? void 0 : _a.map(feed => ({
                    value: new anchor_31_1.BN(feed.value),
                    checksum: buffer_1.Buffer.from(feed.feed_hash, 'hex'),
            ...
            const bundleData = buffer_1.Buffer.alloc(bundleDataLength);
            let offset = 0;
            ...
            for (const feedInfo of data.feedInfos) {
                ...
                const valueBytes = feedInfo.value.toArrayLike(buffer_1.Buffer, 'le', 16);
    ...
    attemptSessionRequest(attempt, maxRetries, feedHints) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (this.config.crossbarMode) {
                ...
                if (!crossbar) {
                    crossbar = new common_1.CrossbarClient((_a = this.config.crossbarUrl) !== null && _a !== void 0 ? _a : 'https://crossbar.switchboard.xyz');
                }
                if (!this.config.gatewayUrl) {
                    this.config.gatewayUrl = (yield crossbar.fetchGateway()).gatewayUrl;
                }
            ...
            if (this.signatureAuth) {
                ...
                if (authHeaders) {
                    ...
                    this.log(`✅ Generated signature for pubkey: ${(_b = this.config.keypair) === null || _b === void 0 ? void 0 : _b.publicKey.toBase58()}`);
                }
                else {
            ...
            this.log(`✅ Session obtained: ${(_c = sessionData.session_token) === null || _c === void 0 ? void 0 : _c.substring(0, 8)}...`);
            return sessionData;
        });
    }
    /**
