import type { AttestEnclaveResponse, BridgeEnclaveResponse, FeedRequest, FetchQuoteResponse, FetchSignaturesConsensusResponse, HealthyOraclesResponse, PingResponse, RandomnessRevealResponse } from './types/gateway.js';
...
export declare class Gateway {
     ...
     * ```
     */
    fetchHealthyOracles(): Promise<HealthyOraclesResponse>;
    endpoint(): string;
    toString(): string;
